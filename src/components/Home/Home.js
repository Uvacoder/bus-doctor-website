                    ...
                    <div className="search-box" style={{padding: "0"}}>
                        ...
                        <form className="form-design" action="assets/webpages/list.html">
                            <div className="form-group search-location">
                                <input type="text" className="form-control" id="location" placeholder="Search Location"/>
                            </div>
                            <div className="form-group search-info">
                                <input type="text" className="form-control" id="want" placeholder="Search Doctors, Clinics, Hospitals, Diseases Etc"/>
                            </div>
            ...
            <div className="col-lg-6 col-md-6 col-sm-6">
                <div className="doctor-blog profile-widget">
                    ...
                    <div className="pro-content">
                        <h3 className="title">
                            <a href="#/">10 foods for Healthy Heart</a> 
                        </h3>
